...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['create'])) {
        ...
        $adres = $_POST['adres'];
        $query = "INSERT INTO uzytkownik (Imie, Nazwisko, Email, Haslo, Adres, ID_Uprawnienia) VALUES (?, ?, ?, ?, ?, 3)";
...
// Pobieranie użytkowników z ID_Uprawnienia = 3
$query = "SELECT * FROM uzytkownik WHERE ID_Uprawnienia = 3";
